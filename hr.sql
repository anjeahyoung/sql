...
from employees;--null값이 포함된 계산은null
...
select employees_id, last_name, job_id, hire_date  "STARTDATE"
from employees;
--과제: 사원들의 사번(Emp #), 이름(Name), 직업(Job), 입사일(Hire Date)을 조회하라.
select employees_id "Emp #", last_name "Name", job_id "Job", hire_date "Hire Date"
from employees;
